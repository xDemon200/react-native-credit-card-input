        ...
        return (
          <CCInput
            ...
            containerStyle={[
              s.inputContainer,
              inputContainerStyle,
              { width: fieldWidth || EXPIRY_INPUT_WIDTH }
            ]}
          />
        );
      case "cvc":
        return (
          <CCInput
            ...
            containerStyle={[
              s.inputContainer,
              inputContainerStyle,
              { width: fieldWidth || CVC_INPUT_WIDTH }
            ]}
          />
        );
      case "name":
        return (
          <CCInput
            ...
            containerStyle={[
              s.inputContainer,
              inputContainerStyle,
              { width: fieldWidth || NAME_INPUT_WIDTH }
            ]}
          />
        );
      case "postalCode":
        return (
          <CCInput
            ...
            containerStyle={[
              s.inputContainer,
              inputContainerStyle,
              { width: fieldWidth || POSTAL_CODE_INPUT_WIDTH }
            ]}
          />
        );
      default:
      ...
      >
        {verticalFormRows.map((row, index) => (
          <View style={[s.verticalFormRow, verticalFormRowStyle]} key={index}>
            {row.fields.map(field => this.renderField(field.name, field.width))}
          </View>
        ))}
      </ScrollView>
    );
